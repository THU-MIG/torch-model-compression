...
module_pruner_reg.regist(nn.ConvTranspose1d, ConvPruner)
module_pruner_reg.regist(nn.ConvTranspose2d, ConvPruner)
module_pruner_reg.regist(nn.ConvTranspose3d, ConvPruner)
